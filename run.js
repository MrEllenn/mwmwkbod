...
auth: state,
browserDescription: ['CyberdarkBOT', 'Linux', '121.0.6167.159'],
version: [2, 2413, 1],
generateHighQualityLinkPreview: true,
resolveMsgBuffer,
});
if(usePairingCode && !rxhl.authState.creds.registered) {
		const phoneNumber = await question('mohon di masukin gan nomor bot lu supaya terhubung dengan  cyberdarkbot di awali dengan Kode Negara:\n');
